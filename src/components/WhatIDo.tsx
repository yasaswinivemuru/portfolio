...
const WhatIDo = () => {
        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
  Build responsive and scalable web applications using Java,
  React, Spring Boot, REST APIs, and modern frontend technologies.
</p>              <h5>Skillset & tools</h5>
  ...
  <div className="what-tags">Anime JS</div>
  ...
  automation workflows, ServiceNow integrations,
